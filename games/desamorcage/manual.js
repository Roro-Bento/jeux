...
(function (global) {
  ...
  var morse = {
    ...
    emoji: '📻',
    html:
      '<p>Une lampe clignote en boucle. Elle change de <b>forme</b> : un <b>rond</b> est un ' +
      '<b>point</b>, une <b>barre</b> est un <b>trait</b>. Une pause bien marquée sépare chaque ' +
      'lettre, et un message « ⟳ le message reprend » indique le retour au début du mot.</p>' +
      '<p class="note">Le démineur peut <b>ralentir le signal</b> avec le bouton sous la lampe. ' +
      'Trois ou quatre lettres suffisent presque toujours à reconnaître le mot dans la liste.</p>' +
      '<p>Décode assez de lettres pour identifier le mot, puis donne la fréquence à composer.</p>' +
