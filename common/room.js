...
(function (global) {
  ...
  // boucle d'animation, remise à zéro à chaque changement d'écran
  (function loop() {
    requestAnimationFrame(loop);
    if (A.frameFn) { try { A.frameFn(); } catch (e) {} }
  })();
  ...
  function renderTimer(box, left, total, idle) {
    ...
    numEl.textContent = fmtClock(shown);
  ...
  var api = {
    ...
    footer: footer,
    logoBlock: logoBlock,
    onFrame: function (fn) { A.frameFn = fn; },
